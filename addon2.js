...
/* Интерфейс */
		...
		Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://zy5arc.github.io/torr_styles.js', 'TMDB Proxy', '@lampa', 'TMDB', nthChildIndex);
		...
		Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://zy5arc.github.io/head_filter.js', 'head_filter', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
						}
						if (value == '2') {
					...
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900');  hideInstall()
						...
						setTimeout(function() {	
							...
							if (myResult) {
								$('div[data-name="head_filters"]').find('.settings-param__status').removeClass('active error wait').addClass('active')
							} else {
								$('div[data-name="head_filters"]').find('.settings-param__status').removeClass('active error wait').addClass('error')
							}
						}, 100);*/
						var myResult = checkPlugin('https://zy5arc.github.io/head_filter.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       if (myResult && pluginStatus !== 0) {
                                                          $('div[data-name="head_filters"]').find('.settings-param__status').removeClass('active error').addClass('active');
                                                       } else if (pluginStatus === 0) {
		...
		Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://zy5arc.github.io/interface_mod_new.js', 'Interface MOD', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
						}
						if (value == '2') {
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							...
							'Interface MOD v2.2.0', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
						}
						if (value == '2') {
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://zy5arc.github.io/interface.js', 'InteractionMain', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
						}
						if (value == '2') {
	         ...
	         Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://zy5arc.github.io/logo.js', 'Logo', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
						}
						if (value == '2') {
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://zy5arc.github.io/maxsm_themes.js', 'Темы maxsm', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
						}
						if (value == '2') {
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://zy5arc.github.io/p.js', 'Подборки', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
						}
						if (value == '2') {
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://zy5arc.github.io/quality.js', 'Quality', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
						}
						if (value == '2') {
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://zy5arc.github.io/rating_omdb.js', 'Rating_omdb', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
						}
						if (value == '2') {
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://zy5arc.github.io/rating.js', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
						}
						if (value == '2') {
						...
						setTimeout(function() {	
							$('div[data-name="Ratingt"]').append('<div class="settings-param__status one"></div>')
							if (myResult) {
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://zy5arc.github.io/ratingup.js', 'RatingUp v2.0', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
						}
						if (value == '2') {
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://zy5arc.github.io/rezkacomment.js', 'Коментарі з HDRezka.ag', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
						}
						if (value == '2') {
	          ...
	          Lampa.SettingsApi.addParam({
						...
						onChange: function(value) {
							if (value == '1') {
								itemON('https://zy5arc.github.io/seasons.js', 'Seasons', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
							}
							if (value == '2') {
	        ...
	        Lampa.SettingsApi.addParam({
						...
						onChange: function(value) {
							if (value == '1') {
								itemON('https://zy5arc.github.io/style_torrs.js', 'Style_torrs', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
							}
							if (value == '2') {
	        ...
	        Lampa.SettingsApi.addParam({
						...
						onChange: function(value) {
							if (value == '1') {
								itemON('https://zy5arc.github.io/style.js', 'Style', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
							}
							if (value == '2') {
                ...
                Lampa.SettingsApi.addParam({
						...
						onChange: function(value) {
							if (value == '1') {
								itemON('https://zy5arc.github.io/surs_quality.js', 'Surs_quality', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
							}
							if (value == '2') {
	        ...
	        Lampa.SettingsApi.addParam({
						...
						onChange: function(value) {
							if (value == '1') {
								itemON('https://zy5arc.github.io/surs.js', 'Surs', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
							}
							if (value == '2') {
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://zy5arc.github.io/torr_styles.js', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://zy5arc.github.io/torr_styles.js";
						...
						var myResult = checkPlugin('https://zy5arc.github.io/torr_styles.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="v"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://zy5arc.github.io/tracks.js', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
						}
						if (value == '2') {
	         ...
	         Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://zy5arc.github.io/tricks.js','tricks', nthChildIndex);
							// console.log("nthChildIndex, переданный в itemON:", nthChildIndex);
						}
						if (value == '2') {
