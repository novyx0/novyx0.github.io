...
langAdd('settings_list_url_desc0',
	{
		ru: 'По умолчанию мы не используем плейлисты <i>ссылка.m3u8</i><br>Вы можете добавить свой плейлист.',
		uk: 'За замовчуванням ми не використовуємо плейлисти <i>посилання.m3u8</i><br>Ви можете додати свій плейлист.',
		be: 'Па змаўчанні мы не выкарыстоўваем плэйлісты <i>спасылка.m3u8</i><br>Вы можаце дадаць свой плэйліст.',
		en: 'We dont use playlists by default <i>link.m3u8</i><br>You can add your own playlist.',
		zh: '默认播放列表来自项目 <i>Ваша ссылка</i><br>您可以将其替换为您自己的。'
	}
);
