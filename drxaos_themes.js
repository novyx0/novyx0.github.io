    ...
    try {
        styleManager.setStyle('drxaos-action-buttons', `
            ...
            .full-start__button.drxaos-btn {
                ...
                padding: 0 !important;
                border-radius: 50% !important;
                background: linear-gradient(135deg, rgba(var(--primary-rgb, 48, 65, 124), 0.22), rgba(var(--bg-rgb, 10, 14, 24), 0.38)) !important;
                border: 1px solid rgba(var(--primary-rgb, 48, 65, 124), 0.4) !important;
                box-shadow: 0 10px 24px rgba(10, 12, 20, 0.55) !important;
                ...
                transition: width 0.24s ease, height 0.24s ease, padding 0.24s ease, border-radius 0.24s ease, transform 0.22s ease, box-shadow 0.22s ease, background 0.22s ease !important;
...
.full-start__button.drxaos-btn.drxaos-expanded {
                ...
                box-shadow: 0 14px 28px rgba(10, 12, 20, 0.55) !important;
            ...
            .full-start__button.drxaos-btn.drxaos-expanded span {
                display: inline-block !important;
                margin-left: 0.3em !important;
            }
            
            .full-start__button.drxaos-btn:hover span,
            .full-start__button.drxaos-btn.focus span,
            .full-start__button.drxaos-btn:focus span {
                display: inline-block !important;
                margin-left: 0.35em !important;
            }
            .full-start__button.drxaos-btn--play {
                background: linear-gradient(135deg, rgba(51, 153, 255, 0.24), rgba(30, 64, 175, 0.18));
