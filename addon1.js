(function () {
    ...
    function addonStart() {
        ...
        /* Добавляем компоненты для всех категорий */
        Lampa.SettingsApi.addComponent({
        ...
        Lampa.SettingsApi.addComponent({
            ...
            name: 'Управление',
            icon: icon_add_management_plugin
        });
        Lampa.SettingsApi.addComponent({
            component: 'add_online_plugin',
            name: 'Онлайн',
            icon: icon_add_online_plugin
        });
        Lampa.SettingsApi.addComponent({
            component: 'add_torrent_plugin',
            name: 'Торренты',
            icon: icon_add_torrent_plugin
        });
        Lampa.SettingsApi.addComponent({
            component: 'add_tv_plugin',
            name: 'ТВ',
            icon: icon_add_tv_plugin
        });
        Lampa.SettingsApi.addComponent({
            component: 'add_music_plugin',
            name: 'Музыка',
            icon: icon_add_music_plugin
        });
        Lampa.SettingsApi.addComponent({
            component: 'add_radio_plugin',
            name: 'Радио',
            icon: icon_add_radio_plugin
        });
        Lampa.SettingsApi.addComponent({
            component: 'add_sisi_plugin',
            name: '18+',
            icon: icon_add_sisi_plugin
        });
        ...
        Lampa.Settings.listener.follow('open', function (e) {
            if (e.name == 'main') {
                ...
                setTimeout(function() {
                    // Удаляем дубли, но не все категории
        ...
        // Параметры для других категорий (пустые структуры)
        Lampa.SettingsApi.addParam({
            component: 'add_plugin',
            param: {
